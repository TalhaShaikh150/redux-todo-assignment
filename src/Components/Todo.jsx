              ...
              todos.map((todo) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="p-2 text-gray-900 hover:text-red-500 cursor-pointer hover:bg-red-50 rounded-lg transition-all duration-200 group-hover:opacity-100 hover:scale-110"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
